...
#[AsCommand(
    name: 'app:fetch-anomalies-spn-dispo',
    description: 'A command that fetches AnomaliesSpnDispo from S3 to the DB',
)]
class FetchAnomaliesSpnDispoCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('Fetch Anomalies SPN Dispo');
        ...
        try {
            ...
            $io->success('Anomalies SPN Dispo fetched successfully.');
    ...
    private function getS3FileName(): string
    {
        ...
        return 'anomalies-grc/Anomalies_ND_Dispos_42L_' . $yesterdayDate . '.csv';
    }
    ...
    {
        $name = "fetch_anomalies_spn_dispo";
